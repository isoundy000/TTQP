...
let jajaleStateMachine = require('state-machine');
...
var jajaleState1 = {
    ...
    connect: function(defaultState = 'ready') {
        ...
        this.fsm = new jajaleStateMachine({
            ...
            transitions: [
                ...
                { name: 'readyHandle', from: 'ready', to: 'bet'},

                { name: 'betHandle', from: 'bet', to: 'deal'},

                { name: 'dealAHandle', from: 'deal', to: 'openCardA'},                
                { name: 'dealBHandle', from: 'deal', to: 'openCardB'},

                { name: 'openAHandle', from: 'openCardA', to: 'openCardB'},
                { name: 'openBHandle', from: 'openCardB', to: 'openCardA'},

                { name: 'openCardHandle', from: 'openCardA', to: 'clearing'},
                { name: 'openCardHandle', from: 'openCardB', to: 'clearing'},
