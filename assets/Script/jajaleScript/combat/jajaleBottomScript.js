...
cc.Class({
     ...
     * 筹码事件
     */
    onWeightsHandle: function(event, customData) {
     ...
     * 申请当家事件
     */
    onApplyForManageHandle: function(event, customData) {
     ...
     * 重复投注事件
     */
    onRepeatBetHandle: function(event, customData) {
        if (this.repeatBetType === 3) { return ;}
     ...
     * 喊话
     */
    onPropagandaHandle: function(event, customData) {
     ...
     * 刷新带入金币 回调
     */
    jajaleRefreshDragInGoldMessage: function (data) {
     ...
     * 带入成功更新总金币 回调
     */
    jajaleRefreshUserGoldMessage: function(data) {
     ...
     * 下发重复取消下注状态 回调
     */
    jajaleRepeatBetStatusMessage: function(data) {
     ...
     * 下发重复投注 回调
     */
    jajaleRepeatBetMessage: function(data) {
        console.log(data);
    },
    /**
     * 下发取消自动下注 回调
     */
    jajaleClearRepeatBetMessage: function(data) {
