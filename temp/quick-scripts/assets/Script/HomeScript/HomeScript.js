(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/HomeScript/HomeScript.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '02dfaOqSlVOwoZ6eAXICeTn', 'HomeScript', __filename);
// Script/HomeScript/HomeScript.js
...
cc.Class({
    ...
    /*************************  事件监听  *************************/
    /**  * 顶部 客服 按钮的点击 */
    onKefuBtnClick: function onKefuBtnClick(event) {
        this.kefuView.getComponent('HomeKefuView').onShowView(true, function () {
            //
        });
    },
    ...
    /**  * 底部 背包 按钮的点击 */
    onPackBtnClick: function onPackBtnClick(event) {
        var self = this;
    ...
    /**  * 底部 活动 按钮的点击 */
    onActivityBtnClick: function onActivityBtnClick(event) {
        var self = this;
    ...
    /**  * 底部 设置 按钮的点击 */
    onSettingBtnClick: function onSettingBtnClick(event) {
        var self = this;
    ...
    /**  * 底部 商城 按钮的点击 */
    onShopBtnClick: function onShopBtnClick(event) {
    ...
    /**  * 底部 签到 按钮的点击 */
    onSignInBtnClick: function onSignInBtnClick(event) {
        var self = this;
        this.signInShowView.getComponent('HomeSignInShowView').onShowView(true, function () {});
    },


    /**  * 底部 邮件 按钮的点击 */
    onEmailBtnClick: function onEmailBtnClick(event) {
        var self = this;
        var emailShowView = this.emailShowView.getComponent('HomeEmailShowView');
        emailShowView.onShowView(true, function (updateData) {
    ...
    /**  * 底部 分享 按钮的点击 */
    onShareBtnClick: function onShareBtnClick(event) {
        this.shareView.getComponent('HomeShareShowView').onShowView(true);
    },


    /**  * 底部 更多 按钮的点击 */
    onMoreBtnClick: function onMoreBtnClick(event) {
        this.moreView.active = !this.moreView.active;
    },


    /**  * 底部 说明 按钮的点击 */
    onIntroBtnClick: function onIntroBtnClick(event) {
        this.userAgreementShowView.getComponent('HomeUserAgreementView').onShowView(true);
    },
    onGameType: function onGameType(event, customData) {
    ...
    /**  * 从大厅切换到游戏 成功回调*/
    cutGameMessage: function cutGameMessage() {
