(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/HomeScript/HomeSettingView/HomeSetDailiInfoView.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'cfae83TylxLNJOmwvWyCHwM', 'HomeSetDailiInfoView', __filename);
// Script/HomeScript/HomeSettingView/HomeSetDailiInfoView.js
...
cc.Class({
    ...
    /*********************** 发送接口 ***********************/
    onGetDailiInfoRequest: function onGetDailiInfoRequest() {
        cc.scn.socket.send(10901);
    },


    /*********************** 接口回调 ***********************/
    onGetDailiInfo: function onGetDailiInfo(data) {
        //
        console.log(data);
        if (data) {
            this.dailiInfo = data;
    ...
    onMenusBtnClick: function onMenusBtnClick(event, customData) {
        ...
        switch (itemIdx) {
            case 0:
                {
                    // 玩家排行
                    this.userPaiHangView.getComponent('HomeSetUserPaiHangView').onShowView(true, function () {
                        //
                    });
                }
                break;
            case 1:
                {
                    // 提现
                    this.tixianView.getComponent('HomeSetTixianView').onShowView(true, function () {
                        //
                    });
                }
                break;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=HomeSetDailiInfoView.js.map
