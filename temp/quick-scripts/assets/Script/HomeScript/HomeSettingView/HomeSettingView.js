(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/HomeScript/HomeSettingView/HomeSettingView.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '0c2cfXIrqBMn724CxdKZtGU', 'HomeSettingView', __filename);
// Script/HomeScript/HomeSettingView/HomeSettingView.js
...
cc.Class({
    ...
    onConfigUI: function onConfigUI() {
        ...
        var sexIdx = ttqp_global.currentUserInfo.sex;
        if (sexIdx != 2) {
            // 这个值有0，1，2，0是默认男，1是男，2是女
            this.isBoy = true;
            this.sexClickIdx = 0;
        } else {
            this.isBoy = false;
    ...
    // 设置性别标记
    onConfigSexNode: function onConfigSexNode(isBoy) {
     ...
     * 获取玩家是否注册过代理请求
     */
    onGetUserIsApplyAgentRequest: function onGetUserIsApplyAgentRequest() {
     ...
     * 设置性别
     */
    onSetUserSex: function onSetUserSex() {
        var params = {
     ...
     * 获取玩家是否注册过代理回调
     */
    onGetUserIsApplyAgent: function onGetUserIsApplyAgent(data) {
        if (data) {
     ...
     * 设置性别回调
     */
    onSetSexHandle: function onSetSexHandle(data) {
        //
    ...
    /// 性别按钮的点击
    onSexBtnClick: function onSexBtnClick(event, customData) {
    ...
    /// 开关按钮的点击
    onIOBtnClick: function onIOBtnClick(event, customData) {
    ...
    onMenusBtnClick: function onMenusBtnClick(event, customData) {
        ...
        switch (itemIdx) {
            case 0:
                {
                    // 申请代理
                    var self = this;
                    this.applyForDailiView.getComponent('HomeSetApplyForDailiView').onShowView(true, function () {
                        //
            ...
            case 1:
                {
                    // 邀请人ID
                    this.yaoqingrenIDView.getComponent('HomeSetYaoqingrenIDView').onShowView(true, function () {
                        //
                    });
                }
                break;
            case 2:
                {
                    ...
                    this.updatePwdView.getComponent('HomeSetUpdatePwdView').onShowView(true, function () {
                        //
                    });
                }
                break;
            ...
            case 4:
                {
                    // 代理信息
                    this.dailiInfoView.getComponent('HomeSetDailiInfoView').onShowView(true, function () {
                        //
                    });
                }
                break;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=HomeSettingView.js.map
