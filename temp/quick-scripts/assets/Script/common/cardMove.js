(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/common/cardMove.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '65587Oi7RpKLLUWqj3Bg6X8', 'cardMove', __filename);
// Script/common/cardMove.js
...
cc.Class({
     ...
     * touch开始时候回调
     */
    cardMoveStart: function cardMoveStart(evnet) {
     ...
     * 设置card的初始化位置
     */
    setShowCardLocation: function setShowCardLocation(isRotate, moveDirection) {
        if (moveDirection == 0) {
            //回复到原始状态
     ...
     * touch进行中回调
     */
    cardMoving: function cardMoving(event) {
        //确定滑动的方向
     ...
     */
    cardMoveEnd: function cardMoveEnd(event) {
     ...
     */
    cardMoveCancel: function cardMoveCancel(event) {
        this.userMoveOver(event);
    },
    /**
     * touch结束的处理
     */
    userMoveOver: function userMoveOver(event) {
        //用户滑松开手指的处理。
        if (!this._isRotate) {
            //没有旋转的处理
     ...
     * 回到搓牌界面
     */
    notLookCard: function notLookCard() {
        this.bg.active = true;
     ...
     * 设置moveStartHook回调
     */
    setMoveStartHook: function setMoveStartHook(moveStartHook) {
        this._moveStartHook = moveStartHook;
    },
    /**
     *设置开牌结束回调
     */
    setOpenCardOverHook: function setOpenCardOverHook(openCardEndHook) {
        this._openCardOverHook = openCardEndHook;
    },
    /**
     * 设置点击旋转按钮的回调
     */
    setRotateCardHook: function setRotateCardHook(rotateCardHook) {
     ...
     * 设置灵敏度
     */
    setSensitiveThr: function setSensitiveThr(sensitive) {
     ...
     */
    initCard: function initCard(showCardLocation) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=cardMove.js.map
